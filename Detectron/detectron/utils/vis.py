...
#OEE changed from pdf to png
    ...
    ax.axis('off')
    bg_black = np.zeros(im.shape) 
    fig.add_axes(ax)
    ax.imshow(bg_black) # OEE created bg_black for masking
        ...
        if segms is not None and len(segms) > i:
            ...
            for c in contour:
                polygon = Polygon(
                    ...
                    alpha= 1.0) 
                #OEE change facecolor from color_mask, edgecolor from 'w', linewidth from 1.2, and alpha from 0.5
